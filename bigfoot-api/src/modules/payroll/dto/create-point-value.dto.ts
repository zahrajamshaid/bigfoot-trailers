...
export class CreatePointValueDto {
  ...
  @ApiProperty({ description: 'FK to departments — must be a production (non-QC) department' })
  @IsInt()
  @Type(() => Number)
  departmentId!: number;

  @ApiProperty({ description: 'Points awarded for completing this model in this department', example: 3.5 })
