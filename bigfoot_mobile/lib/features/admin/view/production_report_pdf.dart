    ...
    children: [
      ...
      pw.Expanded(
        child: _sectionBox('SALES', [
          ...
          _deltaRow('Open-stock orders placed', cur.sales.stockOrdersPlaced,
              prev.sales.stockOrdersPlaced),
          _deltaRow('Open-stock sold', cur.sales.openStockSold,
              prev.sales.openStockSold),
          _deltaRow('  · out of production', cur.sales.openStockSoldFromProduction,
              prev.sales.openStockSoldFromProduction),
          _deltaRow('  · out of inventory', cur.sales.openStockSoldFromInventory,
              prev.sales.openStockSoldFromInventory),
